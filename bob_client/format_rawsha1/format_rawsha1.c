...
static unsigned int rawsha1_crypt_all(int count)
{
#ifdef MMX_COEF
    /* shammx processes 'count' keys in parallel using MMX lanes */
    shammx((unsigned char *)crypt_key,
    ...
    /* return first byte as a quick hash for dispatcher */
